...
const Projects = () => {
  ...
  const toggleProjectTech = (projectId: number) => {
  ...
  const projects = [
    ...
    },
    {
      ...
      category: "Full Stack",
      featured: true,
      type: "professional", // personal or professional
      client: "professional",
        ...
        >
          <div className="grid lg:grid-cols-3 gap-8">
            {featuredProjects.map((project, index) => {
              ...
              const displayTech = isExpanded ? project.technologies : project.technologies.slice(0, 3);
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    {/* Technologies with expand/collapse */}
                    <div className="flex flex-wrap gap-2 mb-6">
                      ...
                      {project.technologies.length > 3 && (
                        <button
                          onClick={() => toggleProjectTech(project.id)}
                          className="px-2 py-1 text-orange-700 hover:text-orange-800 text-xs font-medium  rounded transition-colors"
                        >
                          {isExpanded ? 'Show Less' : `+${project.technologies.length - 3} More`}
                        </button>
                      )}
                    </div>
