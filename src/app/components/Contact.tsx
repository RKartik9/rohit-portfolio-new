...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/xblyarka', {
        method: 'POST',
        headers: {
  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      content: "rohit.kartik9@gmail.com", 
      link: "mailto:rohit.kartik9@gmail.com"
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Phone",
      content: "+91 83402 41584", 
      link: "tel:+918340241584"
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Location",
      content: "India", // Replace with your location
      link: "#"
    }
  ];
  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/rkartik9", // Replace with your LinkedIn
      icon: (
    ...
    {
      name: "Twitter",
      url: "https://twitter.com/RKartik_9", // Replace with your Twitter
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-muted-foreground">
                © {currentYear} Rohit Kartik. All rights reserved.
              </p>
            </div>
            <div className="flex items-center gap-6">
              <motion.a
                href="https://drive.google.com/file/d/1BvQbuwIjRrXLkSVhBiYUEFXVVrP4a4Gl/view?usp=sharing"
                target="_blank"
                rel="noopener noreferrer"
